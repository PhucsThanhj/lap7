<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $target_dir = "./images/";
            ...
            if (isset($tensp) && isset($gia) && isset($mota) && isset($hinhanh)) { move_uploaded_file($_FILES["hinhanh"]["tmp_name"],$target_file); $sql = "UPDATE `sanpham` SET `tensp` = '$tensp', `gia` = '$gia', `mota` = '$mota', `imgURL` = '$hinhanh' WHERE `sanpham`.`masp` = '$masp';"; 
